    ...
    <SelectRadix.Root>
      ...
      <SelectRadix.Portal>
        <SelectRadix.Content
          ...
          position="popper"
          sideOffset={8} // mt 8
          className="z-10 w-[--radix-select-trigger-width] cursor-pointer  overflow-hidden rounded-lg border border-zinc-200 bg-white text-zinc-900 dark:border-zinc-600 dark:bg-zinc-900 dark:text-zinc-100"
        >

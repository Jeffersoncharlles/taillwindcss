    ...
    <div ref={parent} className="mt-4 flex flex-col gap-3">
      {files.map((file) => {
        return (
          ...
          >
            <div className="rounded-full border-4 border-violet-100 bg-violet-200 p-2 text-violet-600 dark:border-violet-600 dark:bg-violet-800 dark:text-violet-300">
